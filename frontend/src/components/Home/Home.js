...
import Mockup from '../../assets/health.svg';
    ...
    <div>
      <div className="circle-wrapper">
        <div className="home-wrapper">
          <div>
            <h1>MedBook— "Achieve Holistic Wellness !" </h1>
            <h2>
            "Schedule Your Comprehensive Healthcare Consultation Now!"
            </h2>
            <br></br>
            <p>Explore our range of services, including nutritional counseling, <br></br> mindfulness training, and more.</p>
            <br></br>
            <br></br>
            ...
            <div className="auth-button-wrapper">
              ...
              <Link to="/authentication" state={{ signIn: false }}>
                <Button action="Sign up" color="dark grey" />
              </Link>
            </div>
          </div>
      ...
      <section className="home-section">
        <div className="home-grid">
          ...
          <div className="col-r">
            <h2> </h2>
            <h2>Features</h2>
            <p>Facing Any Healthcare Problem ? <br/>
              "Collaborate With Us To Schedule Your Appointment!"
              </p>
            <ul>
              <li>Immediate Access to Healthcare- Anytime, Anywhere!</li>
              <li>Enhanced Medical Environment</li>
              <li>Scheduling Appointment Virtually</li>
              <li>Efficient medical administration processing</li>
              <li>Single location for patient data access</li>
              <li>Provide Leading Light to Your HealthCare</li>
            </ul>
          </div>
        </div>
      </section>
      <section className="home-section">
        <footer className="home-grid">
          <div className="col-l">
            <h2>About</h2>
            <h1>MedBook: A Holistic Consultation Services! </h1>
            <ul>
              <li>Aims to streamline common Medical practice Tasks and Processes </li>
              <li>Provide a Centralized, Secure, and User-friendly Platform</li>
              <li>To Facilitates communication and information exchange between Us</li>
              <li>The application aims to enhance the quality of healthcare delivery</li>
              <li>Improve patient outcomes by giving ontime Services</li>
              <br></br>
            </ul>
            <div className="auth-button-wrapper">
              <Link to="authentication" state={{ signIn: true }}>
