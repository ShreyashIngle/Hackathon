...
const Signup = () => {
  ...
  const handleSubmit = async () => {
    if (!formState.isTeacher && checkEmptyInputFields('medication')) {
      setFlashMessage({
    ...
    if (!formState.isTeacher && checkEmptyInputFields('existingConditions')) {
      setFlashMessage({
        message: 'Please fill in all fields that you added',
        type: 'error',
        icon: 'alert',
    ...
    if (!formState.isTeacher && checkEmptyInputFields('allergies')) {
      setFlashMessage({
        message: 'Please fill in all fields that you added',
        type: 'error',
        icon: 'alert',
    ...
    if (!formState.bloodType && !formState.isTeacher) {
      setFlashMessage({
    ...
    if (!formState.weight && !formState.isTeacher) {
      setFlashMessage({
