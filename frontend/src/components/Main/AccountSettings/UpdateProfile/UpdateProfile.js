...
const UpdateProfile = () => {
  ...
  const sanitizeForm = () => {
    ...
    if (formFormRequest.teacherInfo && formFormRequest.teacherInfo.rating) {
      delete formFormRequest.teacherInfo.rating;
    }

    //obj key and subkey
    if (formFormRequest.isTeacher === false) {
    ...
    if (formFormRequest.isTeacher) {
      delete formFormRequest.isTeacher;
    }
        ...
        <div className="form-wrapper">
          ...
          <div className="form-container">
            ...
            <AuthSelect
              ...
              icon="licence"
              onValueChange={e =>
                onNestedValueChange(e, 'teacherInfo', 'licence')
              }
            />
            <AuthInput
